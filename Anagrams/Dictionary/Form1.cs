...
namespace Dictionary {
    ...
    public partial class Form1: Form {
        ...
        private void button14_Click (object sender , EventArgs e)
            ...
            time1.Start();
            MySortedDictionary<string , string> MSD = new MySortedDictionary<string , string>();
            ...
            listBox2.Items.Clear();
            listBox2.Visible = true;
            foreach (string item in MSD.Values)
                if(item.IndexOf(' ')>0) listBox2.Items.Add(item);
            time1.Stop();
            ...
            MessageBox.Show("MySortedDictionary = "+time1.ElapsedMilliseconds+ "\nSortedDictionary = " + time2.ElapsedMilliseconds);
