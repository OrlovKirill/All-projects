...
namespace LIFE
    ...
    class Terrain 
        {
        public static List<BlackCells> listBCells;
        public static bool[,] arrayBCells;
        ...
        public Terrain (Form1 f1)
            ...
            arrayBCells = new bool[Form1.size , Form1.size];
            listBCells = new List<BlackCells>();
        ...
        public void DrawLayout (ref Image bmp)
            {
