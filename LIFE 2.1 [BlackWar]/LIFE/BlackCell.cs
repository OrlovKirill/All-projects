...
namespace LIFE
    ...
    class BlackCells
        ...
        public void Delete (int x , int y)
            ...
            foreach (BCells cell in colony)
                if (cell.x == x && cell.y == y)
                    {
                    for (int i = Array.IndexOf(colony , cell) ; i < colony.Length - 1 && i>=0; i++)
                        colony[i] = colony[i + 1];
                    Array.Resize(ref colony , colony.Length - 1);
                    }
            Terrain.arrayBCells[x , y] = false;
            }
        ...
        public bool CollisionWithColony ()
            ...
            foreach (BCells cell in colony)
                {
                if (cell.x + 1<Form1.size && Terrain.arrayBCells[cell.x + 1 , cell.y] )
                    foreach (BlackCells col in Terrain.listBCells)
                        foreach (BCells curCell in col.colony)
                            if (curCell.x == cell.x + 1 && curCell.y == cell.y && letsWithColony.IndexOf(col) < 0 && Terrain.listBCells.IndexOf(col) != Terrain.listBCells.IndexOf(this))
                                letsWithColony.Add(col);
                if (cell.y+ 1 < Form1.size && Terrain.arrayBCells[cell.x , cell.y + 1])
                    foreach (BlackCells col in Terrain.listBCells)
                        foreach (BCells curCell in col.colony)
                            if (curCell.x == cell.x && curCell.y == cell.y + 1 && letsWithColony.IndexOf(col) < 0 && Terrain.listBCells.IndexOf(col) != Terrain.listBCells.IndexOf(this))
                                letsWithColony.Add(col);
                if (cell.x - 1>=0 && Terrain.arrayBCells[cell.x - 1 , cell.y])
                    foreach (BlackCells col in Terrain.listBCells)
                        foreach (BCells curCell in col.colony)
                            if (curCell.x == cell.x - 1 && curCell.y == cell.y && letsWithColony.IndexOf(col) < 0 && Terrain.listBCells.IndexOf(col) != Terrain.listBCells.IndexOf(this))
                                letsWithColony.Add(col);
                if (cell.y-1 >=0 && Terrain.arrayBCells[cell.x , cell.y - 1])
                    foreach (BlackCells col in Terrain.listBCells)
                        foreach (BCells curCell in col.colony)
                            if (curCell.x == cell.x && curCell.y == cell.y - 1 && letsWithColony.IndexOf(col) < 0 && Terrain.listBCells.IndexOf(col) != Terrain.listBCells.IndexOf(this))
                                letsWithColony.Add(col);
                if (cell.x + 1 < Form1.size && cell.y + 1 < Form1.size && Terrain.arrayBCells[cell.x + 1 , cell.y + 1])
                    foreach (BlackCells col in Terrain.listBCells)
                        foreach (BCells curCell in col.colony)
                            if (curCell.x == cell.x + 1 && curCell.y == cell.y + 1 && letsWithColony.IndexOf(col) < 0 && Terrain.listBCells.IndexOf(col) != Terrain.listBCells.IndexOf(this))
                                letsWithColony.Add(col);
                if (cell.x - 1 >= 0 && cell.y - 1 >= 0 && Terrain.arrayBCells[cell.x - 1 , cell.y - 1])
                    foreach (BlackCells col in Terrain.listBCells)
                        foreach (BCells curCell in col.colony)
                            if (curCell.x == cell.x - 1 && curCell.y == cell.y - 1 && letsWithColony.IndexOf(col) < 0 && Terrain.listBCells.IndexOf(col) != Terrain.listBCells.IndexOf(this))
                                letsWithColony.Add(col);
                if (cell.y - 1 >= 0 && cell.x + 1 < Form1.size && Terrain.arrayBCells[cell.x + 1 , cell.y - 1])
                    foreach (BlackCells col in Terrain.listBCells)
                        foreach (BCells curCell in col.colony)
                            if (curCell.x == cell.x + 1 && curCell.y == cell.y - 1 && letsWithColony.IndexOf(col) < 0 && Terrain.listBCells.IndexOf(col) != Terrain.listBCells.IndexOf(this))
                                letsWithColony.Add(col);
                if (cell.x - 1 >= 0 && cell.y + 1 < Form1.size && Terrain.arrayBCells[cell.x - 1 , cell.y + 1])
                    foreach (BlackCells col in Terrain.listBCells)
                        foreach (BCells curCell in col.colony)
                            if (curCell.x == cell.x - 1 && curCell.y == cell.y + 1 && letsWithColony.IndexOf(col) < 0 && Terrain.listBCells.IndexOf(col) != Terrain.listBCells.IndexOf(this))
                                letsWithColony.Add(col);
        ...
        public void CheckDeath ()
            ...
            if (colony.Length == 0)
                Terrain.listBCells.Remove(this);
